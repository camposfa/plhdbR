...
stage_specific_survival <- function(b, adult_definition = "median", census_start_month = NULL) {
  ...
  ps_ages <- pseudocensus_ages(b, adult_definition, census_start_month)
...
stage_specific_fertility <- function(b, f, adult_definition = "median", annual = TRUE, census_start_month = NULL){
  ...
  # Get life history stage (newborn, juvenile, or adult) of each animal at each
  # pseudocensus date during the study
  ps_ages <- pseudocensus_ages(temp, adult_definition, census_start_month)
...
pseudocensus_ages <- function(b, adult_definition = "median", census_start_month = NULL){
