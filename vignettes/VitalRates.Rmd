...
The function `stage_specific_mortality` uses the biography table to calculate stage-specific mortality separately for each study species for each year of the study. The function 
uses pseudo-census dates on January 1 of each year of the study. The life-history
stages include (following Morris et al. 2011):
